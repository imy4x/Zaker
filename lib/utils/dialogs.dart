...
class AppDialogs {
  ...
  static void showErrorDialog(BuildContext context, String message, {String title = 'حدث خطأ'}) {
    ...
    Color iconColor = isWarning ? const Color(0xFFFDAB3D) : 
                     isSuccess ? const Color(0xFF00B894) : const Color(0xFFE17055);
    Color bgColor = isWarning ? const Color(0xFFFFF8E7) : 
                   isSuccess ? const Color(0xFFE8F8F5) : const Color(0xFFFFF0F0);
    IconData icon = isWarning ? Icons.warning_amber_rounded : 
